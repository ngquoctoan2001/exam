    ...
    public partial class InitialSqlite : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutosaveAnswers", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UploadedBy = table.Column<long>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UserId = table.Column<long>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HomeroomTeacherId = table.Column<long>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClassExamResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClassExamResults_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClassExamResults_Exams_ExamId",
                        column: x => x.ExamId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamFiles", x => new { x.ExamId, x.FileId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamFiles_Files_FileId",
                        column: x => x.FileId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamSettings", x => x.ExamId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ExamId = table.Column<long>(type: "INTEGER", nullable: false),
                    AvgScore = table.Column<decimal>(type: "TEXT", nullable: false),
                    MaxScore = table.Column<decimal>(type: "TEXT", nullable: false),
                    MinScore = table.Column<decimal>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamStatistics", x => x.ExamId);
                    table.ForeignKey(
                        name: "FK_ExamStatistics_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionTagMap", x => new { x.QuestionId, x.TagId });
                    table.ForeignKey(
                        name: "FK_QuestionTagMap_QuestionTags_TagId",
                        column: x => x.TagId,
                        principalTable: "QuestionTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionTagMap_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "TEXT", nullable: false),
                    TotalScore = table.Column<decimal>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Score15p1 = table.Column<double>(type: "REAL", nullable: true),
                    Score15p2 = table.Column<double>(type: "REAL", nullable: true),
                    Score15p3 = table.Column<double>(type: "REAL", nullable: true),
                    ScoreMidterm1 = table.Column<double>(type: "REAL", nullable: true),
                    ScoreMidterm2 = table.Column<double>(type: "REAL", nullable: true),
                    ScoreFinal = table.Column<double>(type: "REAL", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradedBy = table.Column<long>(type: "INTEGER", nullable: true),
                    GradedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GradingResults_ExamAttempts_AttemptId",
                        column: x => x.AttemptId,
                        principalTable: "ExamAttempts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GradingResults_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GradingResults_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnswerCanvases", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AnswerCanvases_Answers_AnswerId",
                        column: x => x.AnswerId,
            ...
            migrationBuilder.CreateTable(
                name: "GradingAnnotations",
                columns: table => new
                {
                    Id = table.Column<long>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    GradingResultId = table.Column<long>(type: "INTEGER", nullable: false),
                    AnnotationData = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradingAnnotations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GradingAnnotations_GradingResults_GradingResultId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradingComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GradingComments_GradingResults_GradingResultId",
                        column: x => x.GradingResultId,
                        principalTable: "GradingResults",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerCanvases_AnswerId",
                table: "AnswerCanvases",
                column: "AnswerId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassExamResults_ClassId",
                table: "ClassExamResults",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassExamResults_ExamId",
                table: "ClassExamResults",
                column: "ExamId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GradingAnnotations_GradingResultId",
                table: "GradingAnnotations",
                column: "GradingResultId");

            migrationBuilder.CreateIndex(
                name: "IX_GradingComments_GradingResultId",
                table: "GradingComments",
                column: "GradingResultId");

            migrationBuilder.CreateIndex(
                name: "IX_GradingResults_AttemptId",
                table: "GradingResults",
                column: "AttemptId");

            migrationBuilder.CreateIndex(
                name: "IX_GradingResults_QuestionId",
                table: "GradingResults",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_GradingResults_TeacherId",
                table: "GradingResults",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionTagMap_TagId",
                table: "QuestionTagMap",
                column: "TagId");
